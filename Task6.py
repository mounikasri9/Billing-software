...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("DMART Billing Machine")
        ...
        lbl_color = "#6a5a59"
        # Title of App
        title = Label(self.root, text="DMART Billing Machine", bd=12, relief=GROOVE, fg=fg_color, bg=bg_color,
                      font=("times new roman", 30, "bold"), pady=3).pack(fill=X)

        # ==========Customers Frame==========#
        F1 = LabelFrame(text="Customer Details", font=("time new roman", 12, "bold"), fg="red", bg=bg_color,
                        relief=GROOVE, bd=10)
        ...
        # ==================Cosmetics Frame=====================#
        F2 = LabelFrame(self.root, text='Cosmetics', bd=10, relief=GROOVE, bg=bg_color, fg="red",
        ...
        # ==================Grocery Frame=====================#
        F2 = LabelFrame(self.root, text='Grocery', bd=10, relief=GROOVE, bg=bg_color, fg="red",
                        font=("times new roman", 13, "bold"))
        ...
        F2 = LabelFrame(self.root, text='Others', bd=10, relief=GROOVE, bg=bg_color, fg="red",
                        font=("times new roman", 13, "bold"))
        ...
        # ===========
        bill_title = Label(F3, text="INVOICE", font=("Lucida", 13, "bold"), bd=7, relief=GROOVE)
    ...
    def welcome_soft(self):
        ...
        self.txt.insert(END, "       Welcome To DMART \n")
